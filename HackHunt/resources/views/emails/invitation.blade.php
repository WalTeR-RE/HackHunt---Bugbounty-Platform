...
<body style="font-family: Arial, sans-serif; background-color: #f4f6f8; padding: 30px;">
    <div style="background-color: #ffffff; padding: 30px; border-radius: 10px;">
        ...
        <p>Program: <strong>{{ $program->name }}</strong></p>
        <p>Click below to accept the invitation and start hunting!</p>
        <a href="{{ $acceptLink }}" style="background-color: #10b981; color: white; padding: 10px 20px; text-decoration: none; border-radius: 5px;">Accept Invitation</a>
        <p>Happy hunting!</p>
